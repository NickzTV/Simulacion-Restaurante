...
public class AdministrarSerializacion {
    ...
    //se guarda el MENU dentro de un ArrayList
    public static void guardarObjetoMenu(ArrayList<Platillo> lista, String nombreArchio){
    ...
    //se LEE el MENU del arraylist
    public static ArrayList<Platillo> LeerObjetosMenu(String nombreArchivo){
        try(ObjectInputStream lectorObjetosMenu = new ObjectInputStream(new FileInputStream(nombreArchivo))){

            ArrayList<Platillo> listaRecuperada = (ArrayList<Platillo>) lectorObjetosMenu.readObject();
            System.out.println("La lista de " + listaRecuperada.size() + " platillos fue recuperada de " + nombreArchivo);
            return listaRecuperada;

        }catch (IOException e){
            guardarObjetoMenu(new ArrayList<Platillo>(), nombreArchivo);

        }catch (ClassNotFoundException e){
            System.err.println("Error al leer la lista de " + nombreArchivo);
        }
        return null;
    }
